...
_STORAGE_DIR = "/srv/anythingllm/storage"


@guard.alias("install AnythingLLM")
@guard.backup_tag("anythingllm", _STORAGE_DIR)
...
@guard.path(_STORAGE_DIR, owner="diot", group="anythingllm", mode="2770")
def main(target: str | None = None, *, runner: PlaybookRunner) -> int:
    ...
    return runner.run_playbook(
        ...
        extravars={"anythingllm_storage_dir": _STORAGE_DIR},
        target=target,
    )
